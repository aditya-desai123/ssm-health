...
class MSALookup:
    def __init__(self, api_key=None):
        ...
        self.api_endpoint = "https://www.huduser.gov/portal/dataset/uspszip-api.html"
...
3. Set the API key when initializing MSALookup:
   msa_lookup = MSALookup(api_key='your_api_key_here')
