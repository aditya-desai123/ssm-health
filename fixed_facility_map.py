#!/usr/bin/env python3
"""
Fixed SSM Health Facility Map with visible markers and proper layer controls
"""
...
def create_fixed_map():
    """Create a fixed facility map with visible markers"""
    ...
    # Color mapping - using only Folium-supported colors
    color_map = {
        'Hospital': 'red',
        'Primary Care': 'blue',
        'Urgent Care': 'orange',
        'Pharmacy': 'green',
        'Imaging': 'purple',
        'Laboratory': 'red',  # Changed from darkred
        'Therapy': 'blue',    # Changed from darkblue
        'Cancer Care': 'green', # Changed from darkgreen
        'Eye Care': 'purple',   # Changed from darkpurple
        'Hospice': 'gray',
        'Unknown': 'lightgray'
    }
    ...
    # Save the map
    output_file = 'ssm_health_fixed_facility_map.html'
    m.save(output_file)
    
    print(f"✅ Fixed facility map created successfully!")
